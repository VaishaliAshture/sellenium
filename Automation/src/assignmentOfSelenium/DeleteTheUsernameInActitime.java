...
public class DeleteTheUsernameInActitime {
		...
		// TODO Auto-generated method stub
		  WebDriver driver = new ChromeDriver();
           ...
           // to perform dropdown
			...
			opt.selectByIndex(0);
			// to fill pwd
			driver.findElement(By.xpath("//input[@name='passwordText']")).sendKeys("k57");
			
			//to fill retype pwd
			driver.findElement(By.xpath("//input[@name='passwordTextRetype']")).sendKeys("k57");
          ...
          driver.findElement(By.xpath("//input[@name='firstName']")).sendKeys("Vaishali");
			...
			// to click on created user
			driver.findElement(By.xpath("//a[text()='Ashture, Vaishali (vishal)']")).click();
